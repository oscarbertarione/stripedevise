...
class PlantillasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plantilla" do
    assert_difference('Plantilla.count') do
      post plantillas_url, params: { plantilla: { curso_id: @plantilla.curso_id, summary: @plantilla.summary, title: @plantilla.title } }
    end
  ...
  test "should update plantilla" do
    patch plantilla_url(@plantilla), params: { plantilla: { curso_id: @plantilla.curso_id, summary: @plantilla.summary, title: @plantilla.title } }
