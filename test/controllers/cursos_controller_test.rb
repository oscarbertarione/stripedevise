...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { content: @curso.content, summary: @curso.summary, title: @curso.title } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { content: @curso.content, summary: @curso.summary, title: @curso.title } }
